...
public class SettlementController {
    ...
    public ResponseEntity<ApiResponse<List<SettlementResponseDto>>> getAllSettlements() {
    ...
    public ResponseEntity<ApiResponse<List<SettlementResponseDto>>> getSettlementsByUser(@Parameter(description = "사용자 ID") @PathVariable Long userId) {
    ...
    public ResponseEntity<ApiResponse<SettlementResponseDto>> getLatestSettlementByUser(@Parameter(description = "사용자 ID") @PathVariable Long userId) {
    ...
    public ResponseEntity<ApiResponse<Integer>> getTotalSettlementAmountByUser(@Parameter(description = "사용자 ID") @PathVariable Long userId) {
    ...
    public ResponseEntity<ApiResponse<List<SettlementResponseDto>>> getSettlementsByProduct(@Parameter(description = "상품 ID") @PathVariable Long productId) {
    ...
    public ResponseEntity<ApiResponse<SettlementResponseDto>> getLatestSettlementByProduct(@Parameter(description = "상품 ID") @PathVariable Long productId) {
    ...
    public ResponseEntity<ApiResponse<Integer>> getTotalSettlementAmountByProduct(@Parameter(description = "상품 ID") @PathVariable Long productId) {
    ...
    public ResponseEntity<ApiResponse<List<SettlementResponseDto>>> getLatestSettlements() {
